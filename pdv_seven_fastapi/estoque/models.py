...
from sqlalchemy import ForeignKey, Numeric, String, Integer, func
from sqlalchemy.orm import Mapped, mapped_column, relationship, registry, mapped_as_dataclass
...
class MovimentacaoEstoque:
    ...
    observacao: Mapped[str | None] = mapped_column(String, nullable=True, default=None)
